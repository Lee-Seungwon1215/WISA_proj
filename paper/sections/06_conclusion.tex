...
accepted-variable-time registry. On a real PQC corpus it is \emph{complete}
(each layer single-covers a leak the others miss, Table~\ref{tab:coverage}),
\emph{validated} (every verdict class maps to a real target,
Tables~\ref{tab:corpus} and~\ref{tab:dudect}), and \emph{honest by
