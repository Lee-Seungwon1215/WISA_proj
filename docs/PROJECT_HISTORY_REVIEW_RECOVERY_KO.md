...
- V2-A가 28축·baseline 3종·assembly·closure를 중단 없이 완주했고, 실행 실패가
  아니라 사전 고정 safety blocker 3건으로 비승격 종료됐음을 원본 수치로 보존
- V2-A의 null-margin 설계 오류, fast positive-control 여유 부족, SMT/turbo 미고정을
  교정한 V10용 KyberSlash v5, Falcon v4, diverse v4, corpus native v5 동결
- 같은 candidate commit의 깨끗한 V3 리허설 2개 없이는 final을 시작할 수 없는
...
1. V10 clean commit에서 blocker-free V3 control rehearsal을 서로 다른 run ID로 2회 완료
...
follow-up validation이다. 현재 V10 승격 gate인 척 꾸며내지 않으며, 없으면 해당
...
| 2026-08-14 | V2-A control 리허설 | 전 단계 완주 후 ML-DSA-44 null-margin 1건과 KyberSlash1 positive-margin 2건으로 비승격 종료; target 통계 미사용 |
| 2026-08-14 | V10 동결 | 최종 4.5 null 판정선 복원, fast-control 13 target 일괄 16,384-tick 끝점, SMT/turbo hard gate, V3 운영 반복 반영 |
| 다음 | qualification/final | 한 host V3 리허설 2회, fresh V10 final, schema-v5 bundle, named analysis, 논문 결과 반영 |
